...
def main_menu():
    while True:
        ...
        print("2. Add New Trip")
        print("3. View All Trips")
        print("4. Search Trips by Driver ID")
        print("5. Update Trip Amount")
        print("6. Delete Trip")
        print("7. Show Analytics")
        print("8. Delete All Trips")
        print("------ DRIVER MANAGEMENT ------")
        print("9. Add Driver")
        print("10. View All Drivers")
        print("11. Search Driver by ID")
        print("12. Update Driver Rating")
        print("13. Delete Driver")
        print("14. Exit")
        print("===========================================")

        opt = input("Enter your choice (1-15): ")
